...
import br.com.telefonica.ssi.regulatorio.commom.interfaces.dbo.FeriadosInt;


@Stateless
public class FeriadosService implements FeriadosInt {
	...
	public List<FeriadosLocais> recuperarFeriadosLocaisPorPeriodo(
		...
		if(ufs != null){
			for(Ufs uf:ufs){
				jpaquery += " AND fl.ufferiado.iduf = " + uf.getId();	
			}	
		}
