...
public class MultipartFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (isMultipartRequest(httpRequest)) {
        	...
        	// De acordo com o tipo do anexo, completa o diretorio final de upload
        	String completardir = httpRequest.getParameter("formupload:caminhoanexo");
            request = new MultipartRequest(httpRequest, location+"/"+completardir);
