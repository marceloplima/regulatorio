...
public class RecuperadorInstanciasBean {
	...
	public static DemandasBean recuperarInstanciaDemandasBean(){
		FacesContext facescontext = FacesContext.getCurrentInstance();
		javax.el.ValueExpression ve = facescontext.getApplication().getExpressionFactory().createValueExpression(facescontext.getELContext(),"#{demandasMB}",DemandasBean.class);
