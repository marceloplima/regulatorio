...
public class AnexosDataModel extends ExtendedDataModel<AnexosRegulatorio> implements java.io.Serializable, Arrangeable {
    ...
    public AnexosDataModel(AnexosInt anexoint, Map<String,Object>filtros) {
        super();
    ...
    public void walk(FacesContext context, DataVisitor visitor, Range range, Object argument) {
		...
		List<AnexosRegulatorio>data = anexoint.retornarPaginado(firstRow, numberOfRows, filtros);
		
        for (AnexosRegulatorio t : data) {
    ...
    @Override
    public AnexosRegulatorio getRowData() {
...
//    	else{
	...
	public Integer getId(Object obj) {
		AnexosRegulatorio d = (AnexosRegulatorio)obj;
		return d.getId();
	}
