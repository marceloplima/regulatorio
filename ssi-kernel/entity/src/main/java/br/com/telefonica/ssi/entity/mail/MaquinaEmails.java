package br.com.telefonica.ssi.entity.mail;
 ...
 * Se o JMS de envio conseguir enviar o email pelo Sendmail, o flagenviado e setado pra true(1)
 * Caso contrario o flag sera setado como false(0)
 * 
...
@Entity
@Cacheable
@Table(name="MaquinaEmails",schema="dbo")
public class MaquinaEmails implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2327669849059922845L;
